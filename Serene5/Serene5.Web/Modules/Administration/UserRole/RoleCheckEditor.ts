import { CheckTreeEditor, CheckTreeItem, Decorators, GridUtils, Select2 } from "@serenity-is/corelib";
import { isEmptyOrNull } from "@serenity-is/corelib";
import { RoleRow } from "../";

@Decorators.registerEditor('Serene5.Administration.RoleCheckEditor')
